...
public:
    ...
    static void drawFrame(bool forceClear = true) {
        ...
        string frame =
            ...
            "  |    ____________________________________________________" + string(colorGray) + " /" + ansiReset + highlightBlack + " " + string(colorGray) + "*" + ansiReset + highlightBlack + "|  |  " + string(highlightBlack) + "|       " + string(colorGreen) + "." + ansiReset + highlightBlack + "" + string(colorRed) + "." + ansiReset + highlightBlack + "|" + ansiReset + highlightBlack + " "+ string(colorGray) + "*" + ansiReset + highlightBlack +"|\n" +
            ...
            "  |   |" + highlightBlue + "                                                    " + ansiReset + highlightBlack + "|  " + string(colorGray) + "*" + ansiReset + highlightBlack + "|"+highlightBlack+"  |  "+string(highlightBlack)+"|    " + string(colorGray) + "|" + ansiReset + highlightBlack + "    |"+ansiReset+highlightBlack+" "+ string(colorGray) + "*" + ansiReset + highlightBlack +"|\n"+highlightBlack
            "  |   |" + highlightBlue + "                                                    " + ansiReset + highlightBlack + "|  " + string(colorGray) + "*" + ansiReset + highlightBlack + "|"+highlightBlack+"  |  "+string(highlightBlack)+"|    " + string(colorGray) + "|" + ansiReset + highlightBlack + "    |"+ansiReset+highlightBlack+" "+ string(colorGray) + "*" + ansiReset + highlightBlack +"|\n"+highlightBlack
            "  |   |" + highlightBlue + "                                                    " + ansiReset + highlightBlack + "|  " + string(colorGray) + "*" + ansiReset + highlightBlack + "|"+highlightBlack+"  |  "+string(highlightBlack)+"|    " + string(colorGray) + "|" + ansiReset + highlightBlack + "    | "+ string(colorGray) + "*" + ansiReset + highlightBlack +""+ansiReset+highlightBlack+"|\n"
            ...
            "  |   |" + highlightBlue + "                                                    " + ansiReset + highlightBlack + "|  " + string(colorGray) + "*" + ansiReset + highlightBlack + "|"+highlightBlack+"  |  "+string(highlightBlack)+"|  " + string(colorGray) + "/---\\" + ansiReset + highlightBlack +"  | "+ string(colorGray) + "*" + ansiReset + highlightBlack +""+ansiReset+highlightBlack+"|\n"
            "  |   |" + highlightBlue + "                                                    " + ansiReset + highlightBlack + "|  " + string(colorGray) + "*" + ansiReset + highlightBlack + "|"+highlightBlack+"  |  "+string(highlightBlack)+"| " + string(colorGray) + "|xxxxx|" + ansiReset + highlightBlack +" | "+ string(colorGray) + "*" + ansiReset + highlightBlack +""+ansiReset+highlightBlack+"|\n"
            "  |   |" + highlightBlue + "                                                    " + ansiReset + highlightBlack + "|  " + string(colorGray) + "*" + ansiReset + highlightBlack + "|"+highlightBlack+"  |  "+string(highlightBlack)+"|  " + string(colorGray) + "\\---/" + ansiReset + highlightBlack +"  | "+ string(colorGray) + "*" + ansiReset + highlightBlack +""+ansiReset+highlightBlack+"|\n"
            "  |   |" + highlightBlue + "                                                    " + ansiReset + highlightBlack + "|  " + string(colorGray) + "*" + ansiReset + highlightBlack + "|"+highlightBlack+"  |  "+string(highlightBlack)+"|         | "+ string(colorGray) + "*" + ansiReset + highlightBlack +""+ansiReset+highlightBlack+"|\n"
            "  |   |" + highlightBlue + "                                                    " + ansiReset + highlightBlack + "|  " + string(colorGray) + "*" + ansiReset + highlightBlack + "|"+highlightBlack+"  |  "+string(highlightBlack)+"| " + string(colorGray) + "- :=: - " + ansiReset + highlightBlack +"| "+ string(colorGray) + "*" + ansiReset + highlightBlack +""+ansiReset+highlightBlack+"|\n"
            "  |   |" + highlightBlue + "                                                    " + ansiReset + highlightBlack + "|  " + string(colorGray) + "*" + ansiReset + highlightBlack + "|"+highlightBlack+"  |  "+string(highlightBlack)+"|         | "+ string(colorGray) + "*" + ansiReset + highlightBlack +""+ansiReset+highlightBlack+"|\n"
            "  |   |" + highlightBlue + "                                                    " + ansiReset + highlightBlack + "|  " + string(colorGray) + "*" + ansiReset + highlightBlack + "|"+highlightBlack+"  |  "+string(highlightBlack)+"|   " + string(colorGray) + "/ \\" + ansiReset + highlightBlack + "   | "+ string(colorGray) + "*" + ansiReset + highlightBlack +""+ansiReset+highlightBlack+"|\n"
            "  |   |" + highlightBlue + "                                                    " + ansiReset + highlightBlack + "|  " + string(colorGray) + "*" + ansiReset + highlightBlack + "|"+highlightBlack+"  |"+string(highlightBlack)+"  |  " + string(colorGray) + "| O | " + ansiReset + highlightBlack + " | "+ string(colorGray) + "*" + ansiReset + highlightBlack +""+ansiReset+highlightBlack+"|\n"
            ...
            "          / _)               " + string(colorRed) + "t" + string(colorYellow) + "t" + string(colorGreen) + "t" + string(colorRed) + "t" + string(colorWhite) + "t" + string(colorCyan) + "t" + string(colorGreen) + "t" + ansiReset + highlightBlack + "                  (_ \\    " + string(highlightBlack) + "     " + string(colorGray) + " " + ansiReset + highlightBlack +"\\|_________|" + ansiReset + highlightBlack + "/\n"
            " ________/ /_____________________" + ansiReset + highlightBlack + "_______________________\\ \\________" + string(colorGray) + "\\" + ansiReset + highlightBlack +"_V_________V_____\n"


            "/  " + string(highlightBlack) + "    ________________________________________________" + ansiReset + highlightBlack + "" + string(highlightBlack) +"   " + "      " + string(colorGray) + "____\\______" + ansiReset + highlightBlack + "         /\n"
            "/  " + string(highlightBlack) + "    | " + string(colorCyan) + "[ESC] [F1] [F2] [F3] [F4] [F5] [F6] [F7] [F8] " + ansiReset + highlightBlack + "" + string(highlightBlack) + "|        " + string(colorGray) +"|[\\] () [\\]|" + ansiReset + highlightBlack + "        /\n"
            "/   " + string(highlightBlack) + "    | " + string(colorGray) + "["+ string(colorGreen) + "." + ansiReset + string(highlightBlack) + string(colorGray) +"UP] [ Q] [ W] [ E] [ R] [ T] [ Y] [ U] [ I]" + ansiReset + highlightBlack + " " + string(highlightBlack) + "|        " + string(colorGray) + "|[ ]    [ ]|" + ansiReset + highlightBlack + "       /\n"
            "/    " + string(highlightBlack) + "    | " + string(colorGray) + "[CMD] [ A] [ S] [ D] [ F] [ G] [ H] [ J] [ K] " + ansiReset + highlightBlack + "" + string(highlightBlack) + "|        " + string(colorGray) + "| Logitech "  "|"+ ansiReset + highlightBlack +"      /\n"
            "/     " + string(highlightBlack) + "    |_________________"+ string(colorGray) +"[ --SPACE-- ]"+ ansiReset + highlightBlack +"_________________|" + ansiReset + highlightBlack + "        "+string(colorGray)+"|__________|"+ ansiReset + highlightBlack"   " + string(highlightBlack) + "" + string(colorGray) + "" + ansiReset + highlightBlack + "  " + string(colorGreen) + "" + ansiReset + highlightBlack + "/\n"
            "/_____________________________________________________________________________" + string(highlightBlack) + "___" + ansiReset + highlightBlack + "___/\n";
        cout << frame << endl; 
        cout << ansiReset; 
    }
...
public:
    ...
    void run() {
        clearScreen();
        cout << string(highlightGreen) << "\n\033[8C"  << "Press Enter to start..."+ string(ansiReset) + string(highlightBlack);
        cin.ignore();
        cout << ansiReset;
        clearScreen();
        UI::bootScreen();
